...
/**
 * PermissionsStrings - for command annotation
 * 
 * @author lycano
 */
public class PermissionsStrings {
    public static final String version = "help.version";    
    public static final String menu = "help.menu";    
    public static final String search = "help.search";    
    public static final String list = "help.list";
}
